...
double hits_sphere(const ray& r, const point3& center, const double radius){
...
color ray_color(const ray& r){
    auto t = hits_sphere(r, point3(0, 0, -1), 0.5);
    if(t > 0){
        vec3 n = unit_vector(r.ray_at(t) - vec3(0, 0, -1));
...
int main() {
        ...
        //Calculate image height and clamp to 1
